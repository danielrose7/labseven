...
export const usePaginatedProducts = (fallbackData, routeParams = {}, delay = 350) => {
  ...
  const endpoint =
    "/api/products?" + stringify({ ...debouncedQuery, ...routeParams });
  ...
  const isDefaultQuery =
    ...
    (page === 1 &&
      ...
      (!query.color || query.color === "")); // no color filter
